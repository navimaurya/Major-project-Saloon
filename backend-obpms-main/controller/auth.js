...
const emailVerification = async (user, token, req, res, next) => {
    //   // console.log(user)
    //  // console.log(user);
...
exports.signup = catchAsync(async (req, res, next) => {
    ...
    await emailVerification(newUser, token, req, res, next)
